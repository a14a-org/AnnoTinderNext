...
CREATE TABLE "forms" (
    ...
    "quotaSettings" TEXT,
    "assignmentStrategy" TEXT NOT NULL DEFAULT 'INDIVIDUAL',
...
CREATE TABLE "job_sets" (
    ...
    CONSTRAINT "job_sets_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "job_sets_formId_idx" ON "job_sets"("formId");

-- CreateIndex
CREATE UNIQUE INDEX "job_sets_formId_shortId_key" ON "job_sets"("formId", "shortId");

-- CreateIndex
CREATE INDEX "articles_formId_idx" ON "articles"("formId");

-- CreateIndex
CREATE INDEX "articles_jobSetId_idx" ON "articles"("jobSetId");
...
-- CreateIndex
CREATE INDEX "annotation_sessions_jobSetId_idx" ON "annotation_sessions"("jobSetId");
...
-- AddForeignKey
ALTER TABLE "job_sets" ADD CONSTRAINT "job_sets_formId_fkey" FOREIGN KEY ("formId") REFERENCES "forms"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "articles" ADD CONSTRAINT "articles_jobSetId_fkey" FOREIGN KEY ("jobSetId") REFERENCES "job_sets"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "annotation_sessions" ADD CONSTRAINT "annotation_sessions_jobSetId_fkey" FOREIGN KEY ("jobSetId") REFERENCES "job_sets"("id") ON DELETE SET NULL ON UPDATE CASCADE;
